...
class ChessBoard {
   ...
   */ setupDataModel() {
    ...
    checkIfPlayerIsInCheck(targetPlayer) {
   ...
   * check mate
   */ checkIfPlayerIsInCheckmate(targetPlayer) {
        const otherPlayer = this.whitePlayer == targetPlayer ? this.blackPlayer : this.whitePlayer;
        otherPlayer.pieces.forEach((piece)=>{
            const validMoves = piece.findValidMoves(this);
            // If king is in check
   ...
   */ updateDisplay(lightMode = null) {
        ...
        if (this.redraw) {
            this.flatTileList.forEach((tile)=>{
                ...
                if (tile.currentPiece) curTileElm.style.color = tile.currentPiece.color;
                let displayText = "";
...
},{"./ChessPieces/Bishop":"bvFql","./ChessTile":"lm55V","./ChessPieces/Knight":"dMoLL","./ChessPieces/Pawn":"kkl9H","./ChessPieces/Rook":"aeyIp","./ChessPieces/Queen":"4jvJS","./ChessPieces/King":"3pGdD","./Player":"8YLWx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bvFql":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class ChessPiece {
    constructor(boardTiles, x, y, color = "white"){
        this.color = color;
...
},{"./ChessPieces/King":"3pGdD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1VAOD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
