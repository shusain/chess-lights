...
var _sequencePattern = require("./SequencePattern");
var _snakePattern = require("./SnakePattern");
class ChessLightsMain {
    constructor(){
        window.addEventListener('DOMContentLoaded', (event1)=>{
            ...
            this.chessBoard = new _chessBoard.ChessBoard();
    ...
    updateDisplay() {
        if (this.mode) this.chessBoard = this.mode.updatePattern(this.chessBoard);
    ...
    buildBoard() {
        ...
        const lightRowDOMElms = this.chessBoard.lightRows.map((lightDataRow)=>{
...
},{"./ChessBoard":"euRaP","./RowPattern":"cjFFq","./SequencePattern":"cTaua","./SnakePattern":"8BZDu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"euRaP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ChessBoard", ()=>ChessBoard
);
...
class ChessBoard {
    setupDataModel() {
        ...
        for(let i = 0; i < this.flatLightList.length; i++){
            ...
            if (i < this.flatLightList.length - 1) currentLight.nextLight = this.flatLightList[i + 1];
        }
    ...
    makeRow(rowNum) {
        ...
        for(let x = 0; x < 8; x++){
            const newLightObject = new _chessTile.ChessTile(this.counter++, x, rowNum);
...
},{"./ChessTile":"lm55V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lm55V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ChessTile", ()=>ChessTile
);
class ChessTile {
...
},{}],"cjFFq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RowPattern {
    updatePattern(currentBoard) {
        ...
        if (this.currentlyLitLightRow >= currentBoard.lightRows.length) this.currentlyLitLightRow = 0;
        return currentBoard;
    }
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cTaua":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8BZDu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
